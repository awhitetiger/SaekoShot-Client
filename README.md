Client for the SaekoShot Server, when ran it will create a config.ini file in the directory it was ran in. Edit this file to match your servers information.
